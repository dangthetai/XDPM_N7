...
public class MainActivity extends SimpleBaseGameActivity {
	...
	protected void onCreateResources() {
		// TODO Auto-generated method stub
		vang250=new Sprites(293,229,"menu/vang250.png",1,1,this,this.getTextureManager());
		vang250.setPoint(25, 40);
		oldman=new Sprites(535,435,"menu/oldMan.png",1,1,this,this.getTextureManager());
		oldman.setPoint(vang250.getX()+245, vang250.getY()+10);
		btstart=new Sprites(348,41,"menu/startButton.png",2,1,this,this.getTextureManager());
